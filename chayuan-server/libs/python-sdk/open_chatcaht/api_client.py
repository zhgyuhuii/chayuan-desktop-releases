...
CHAYUAN_API_BASE = get_variable(os.getenv("CHAYUAN_API_BASE"), "http://127.0.0.1:8000")
CHAYUAN_CLIENT_TIME_OUT = get_variable(os.getenv("CHAYUAN_CLIENT_TIME_OUT"), 60)
CHAYUAN_CLIENT_DEFAULT_RETRY_COUNT = get_variable(os.getenv("CHAYUAN_CLIENT_DEFAULT_RETRY"), 3)
CHAYUAN_CLIENT_DEFAULT_RETRY_INTERVAL = get_variable(
    os.getenv("CHAYUAN_CLIENT_DEFAULT_RETRY_INTERVAL"), 60
)
...
class ApiClient:
    ...
    def __init__(
        ...
        if proxies is None:
            proxies = {}
        self.base_url = get_variable(base_url, CHAYUAN_API_BASE)
        self.timeout = get_variable(timeout, CHAYUAN_CLIENT_TIME_OUT)
        self._use_async = use_async
        self.use_proxy = use_proxy
        self.default_retry_count = get_variable(retry, CHAYUAN_CLIENT_DEFAULT_RETRY_COUNT)
        self.default_retry_interval = get_variable(
            retry_interval, CHAYUAN_CLIENT_DEFAULT_RETRY_INTERVAL
        )
