...
class ZillizKBService(KBService):
    ...
    # 同 Milvus：Zilliz 底层用的也是 pymilvus，collection 名必须 ASCII 合法标识符。
    ...
    def get_collection(zilliz_name):
        ...
        return Collection(safe_vs_collection_name(zilliz_name))
    ...
    def search(zilliz_name, content, limit=3):
        ...
        c = ZillizKBService.get_collection(safe_vs_collection_name(zilliz_name))
        return c.search(
