...
from chayuan.server.pydantic_v1 import root_validator
...
from langchain_chayuan.agents.output_parsers.platform_tools import PlatformToolsAgentOutputParser
from langchain_chayuan.agents.output_parsers import MCPToolAction
...
class PlatformToolsAgentExecutor(AgentExecutor):
    ...
    def _perform_agent_action(
        ...
        # Otherwise we lookup the tool
            ...
            # TODO: platform adapter tool for all  tools,
            #       view tools binding langchain_chayuan/agents/platform_tools/base.py:188
    ...
    async def _aperform_agent_action(
        ...
        # Otherwise we lookup the tool
            ...
            # TODO: platform adapter tool for all  tools,
            #       view tools binding
            #       langchain_chayuan.agents.platform_tools.base.PlatformToolsRunnable.paser_all_tools
            if agent_action.tool in AdapterAllToolStructType.__members__.values():
