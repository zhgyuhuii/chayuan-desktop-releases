...
from langchain_chayuan.agents.output_parsers.tools_output.base import (
...
from langchain_chayuan.agents.output_parsers.tools_output.drawing_tool import (
    _best_effort_parse_drawing_tool_tool_calls,
    _paser_drawing_tool_chunk_input,
)
from langchain_chayuan.agents.output_parsers.tools_output.function import (
    _best_effort_parse_function_tool_calls,
    _paser_function_chunk_input,
)
from langchain_chayuan.agents.output_parsers.tools_output.web_browser import (
    _best_effort_parse_web_browser_tool_calls,
    _paser_web_browser_chunk_input,
)
from langchain_chayuan.chat_models.platform_tools_message import PlatformToolsMessageChunk
...
def parse_ai_message_to_tool_action(
    ...
    # TODO: parse platform tools built-in @langchain_chayuan.agents.platform_tools.base._get_assistants_tool
    ...
    # TODO: parse platform tools built-in @langchain_chayuan
